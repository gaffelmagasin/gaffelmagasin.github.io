function open_article(str){
		...
		function draw_article_button(div_id, article_name,small){
			...
			.then(function(resp){
				...
				//bild
				new_html += `<div style = "width:100%; height: auto; display: table; margin-bottom: 10px; postion: relative;">
				...
				//porträtt
					...
					new_html += `<img src = "https://i.imgur.com/Y955Yz7.png" style = "width: 10%; height 10%; position: absolute; left: 30%; bottom: 0px; z-index: 2;"> </img>`
